...
export const DEFAULT_ALIGNMENT_SERVICES: readonly AlignmentServicePreset[] = [
  { displayOrder: 1, particular: "Wheel Alignment 3D", defaultRate: 0, defaultQuantity: 1 },
  { displayOrder: 2, particular: "Wheel Balancing", defaultRate: 0, defaultQuantity: 1 },
  { displayOrder: 3, particular: "Automatic Tire Changing", defaultRate: 0, defaultQuantity: 1 },
  { displayOrder: 4, particular: "Weight - Normal / Alloys", defaultRate: 0, defaultQuantity: 1 },
  { displayOrder: 5, particular: "Puncher Repair / Tubeless", defaultRate: 0, defaultQuantity: 1 },
  { displayOrder: 6, particular: "Tire Rotation", defaultRate: 0, defaultQuantity: 1 },
